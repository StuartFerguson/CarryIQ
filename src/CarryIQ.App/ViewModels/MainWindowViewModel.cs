...
public sealed partial class MainWindowViewModel : ObservableObject
{
    ...
    public MainWindowViewModel(IApplicationPaths applicationPaths)
    {
    ...
    public PlaceholderScreenViewModel? CurrentScreen => SelectedNavigationItem?.Screen;
    ...
    private static ShellNavigationItemViewModel CreateNavigationItem(
        ...
        string footer)
    {
        var screen = new PlaceholderScreenViewModel(title, summary, highlights, footer);
